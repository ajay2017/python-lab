...
- **Claude-authored commits** end with the trailer `Co-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>`, written via `.git/COMMIT_MSG.txt` + `git commit -F` (dodges PowerShell here-string mangling).
