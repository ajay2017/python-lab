...
def build_watchlist_recommendation(ticker: str, data: dict) -> dict:
    ...
    Keys: ticker, action, priority, score, signal, price, entry_lo, entry_hi,
          ...
          conditions_met, conditions_missing, goldman_lens
    """
    ...
    if "Sell" in rec_label or "Strong Sell" in rec_label or score < 44:
        return _card(
            ...
            goldman_lens=(
                "Goldman's framework for watchlist management: a stock on your watchlist is a "
    ...
    if earn_soon and score >= 55:
        return _card(
            ...
            goldman_lens=(
                ...
                "Goldman's PM approach: 'New positions get established after confirmation, not before binary events.' "
    ...
    if score >= 65 and (in_zone or near_zone) and (rr is None or rr >= 2.0):
        return _card(
            ...
            goldman_lens=(
                ...
                "Goldman's traders call this 'entry paralysis' — it's the flip side of chasing. "
    ...
    if score >= 65 and pct_above is not None and pct_above <= 8:
        return _card(
            ...
            goldman_lens=(
                ...
                "Goldman's trading desk rule: if a stock has moved more than 5% above its technical entry zone, "
    ...
    if score >= 65:
        ...
        return _card(
            ...
            goldman_lens=(
                "The watchlist is where patience creates alpha. Goldman's PMs explicitly separate "
    ...
    return _card(
        ...
        goldman_lens=(
            ...
            "Goldman's approach: the watchlist is not just a holding area — it's an active "
