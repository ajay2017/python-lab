...
| 2026-06-10 | Home perf — architecture.md Known-Behaviours + coordination-cache rows | Haiku | 42,606 | ~$0.07 | ~$0.29 | ~$0.22 | Mechanical doc rows (the strong-saving lane). Handed the facts; doc-writer matched house style |
...
| 2026-06-10 | Rec-history hardening — architecture.md Known-Behaviours + constant row | Haiku | 49,651 | ~$0.08 | ~$0.34 | ~$0.26 | Mechanical doc rows (strong-saving lane); handed the facts |
