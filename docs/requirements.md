...
| F-153b | **F-153 data-maturity guards.** A section is **suppressed** (not fabricated) when its data is too thin: entry-quality (Q0) needs ≥ N matured graded entries; thesis discipline (Q2) needs ≥ M thesis reviews with an outcome window; cross-month patterns (Q3) need ≥ 2 monthly reports. These floors are **measurement windows, not gates** — they never affect what the engine recommends. Q1 (signal discipline) is available from month 1. |
