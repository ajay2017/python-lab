...
**Status:** ✅ **PHASE 1 SHIPPED 2026-08-14.** Design approved from the mockup the
same day, built same session. Phase 2 (the Trade Plan pointer) remains open — see §7.
Design questions resolved with the user 2026-08-14 (see §0).
**Proposed F-ID:** F-237
